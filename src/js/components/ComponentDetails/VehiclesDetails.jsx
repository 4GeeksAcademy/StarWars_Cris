...
const VehiclesDetails = () => {
    ...
    if (cargando) {
        return <h1 className="sw-title">Cargando vehículo desde muy muy lejos...</h1>;
    }

    if (error || !detailsVehicle) {
        return <h1 className="sw-title">Error cargando el vehículo</h1>;
    }
